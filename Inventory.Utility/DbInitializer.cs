...
namespace Inventory.Utility
{
    public class DbInitializer :IDbInitializer
    {
        ...
        public async Task SendMail(string FromEmail, string FromName, string Message, string toEmail, string toName, string subject, string smtpUser, string smtpPassword, string smptHost, string smtpPort, bool smtpSSL)
        {
            var body=Message;
